import {cometError, CometResult, CometState, ParseRequestOptions} from "@affinity-lab/comet";
import {reform} from "reformdata";

export function fetchArgsMiddleware<REQ extends {request: any, cookies: any, url: any} = any>(options?: ParseRequestOptions) {
