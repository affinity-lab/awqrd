...
exports.storageError = {
    ...
    tooManyFiles: (name, id, filename, limit) => (0, util_1.createErrorData)("no more storage allowed", { name, id, filename, limit }, 500),
    attachedFileNotFound: (name, id, filename) => (0, util_1.createErrorData)("attached file not found", { name, id, filename }, 500)
};
(0, util_1.preprocessErrorTree)(exports.storageError, "STORM_STORAGE");
