...
function methodCacheFactory(cacheService) {
    ...
    return function (ttl) {
        ...
        return function (target, propertyKey, descriptor) {
            var innerFunction = target[propertyKey];
            ...
            return __assign(__assign({}, descriptor), { 
                ...
                value: function () {
                    ...
                    return __awaiter(this, void 0, void 0, function () {
                        var key, cached, value;
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    key = id + crypto_1.default.createHash('md5').update(JSON.stringify(args)).digest("hex");
                                    return [4 /*yield*/, cacheService.get(key)];
                                case 1:
                                    cached = _a.sent();
                                    if (cached)
                                        return [2 /*return*/, cached];
                                    return [4 /*yield*/, innerFunction.apply(this, args)];
                                case 2:
                                    value = _a.sent();
                                    return [4 /*yield*/, cacheService.set({ key: key, value: value }, ttl)];
                                case 3:
                                    _a.sent();
