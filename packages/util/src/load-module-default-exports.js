...
function loadModuleDefaultExports(dir) {
    ...
    var records = fast_glob_1.default.globSync(path_1.default.join(dir + "/*.{ts,js}").replaceAll("\\", "/"));
    // Load each module asynchronously and push the default export into the 'modules' array
    records.map(function (filename) { return __awaiter(_this, void 0, void 0, function () {
        var module;
        return __generator(this, function (_a) {
            module = require(filename).default;
            modules.push(module);
            return [2 /*return*/];
        });
    }); });
