...
function removeEmptyParentDirectories(dir) {
    return __awaiter(this, void 0, void 0, function () {
        var parent_1, list, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 5, , 6]);
                    parent_1 = path.parse(dir).dir;
                    return [4 /*yield*/, fs.promises.readdir(dir)];
                case 1:
                    list = _a.sent();
                    if (!(list.length === 0)) return [3 /*break*/, 4];
                    return [4 /*yield*/, fs.promises.rmdir(dir)];
                case 2:
                    _a.sent();
                    return [4 /*yield*/, removeEmptyParentDirectories(parent_1)];
                case 3:
                    _a.sent();
                    _a.label = 4;
                ...
                case 5:
                    error_1 = _a.sent();
                    console.error("Error removing directory: ".concat(dir), error_1);
                    return [3 /*break*/, 6];
