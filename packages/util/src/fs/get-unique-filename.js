...
function getUniqueFilename(directory, filename) {
    return __awaiter(this, void 0, void 0, function () {
        var baseName, extName, newName, count;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    baseName = path_1.default.basename(filename, path_1.default.extname(filename));
                    extName = path_1.default.extname(filename);
                    newName = filename;
                    count = 1;
                    _a.label = 1;
                case 1: return [4 /*yield*/, (0, file_exists_1.fileExists)(path_1.default.resolve(directory, newName))];
                case 2:
                    if (!_a.sent()) return [3 /*break*/, 3];
                    newName = "".concat(baseName, "(").concat(count++, ")").concat(extName);
                    return [3 /*break*/, 1];
                case 3: return [2 /*return*/, newName];
            }
        });
    });
}
